...
Feature: Library - Syntax Templates - Criteria - Run-in - Parent
  ...
  Scenario: [Navigation] User must be able to navigate to the Run-in Criteria template under the Syntax template Library
  ...
  Scenario: [Actions][Availability][Draft item] User must only have access to aprove, edit, delete, history actions for Drafted version of the Run-in Criteria template
    Given [API] 'Run-in' Criteria in status Draft exists
    And The 'library/criteria_templates/Run-in/parent' page is opened
    And User intercept getCriteria request
    And User awaits for the getCriteria request to finish
  ...
  Scenario: [Actions][Availability][Final item] User must only have access to new version, inactivate, history actions for Final version of the Run-in Criteria template
    Given [API] 'Run-in' Criteria in status Draft exists
    And [API] Criteria is approved
    And The 'library/criteria_templates/Run-in/parent' page is opened
    And User intercept getCriteria request
  ...
  Scenario: [Actions][Availability][Final item] User must have access to edit indexing, create pre-instantiation actions for Final version of the Run-in Criteria template
    Given [API] 'Run-in' Criteria in status Draft exists
    And [API] Criteria is approved
    And The 'library/criteria_templates/Run-in/parent' page is opened
    And User intercept getCriteria request
  ...
  Scenario: [Actions][Availability][Retired item]User must only have access to reactivate, history actions for Retired version of the Run-in Criteria template
    Given [API] 'Run-in' Criteria in status Draft exists
    And [API] Criteria is approved
    And [API] Criteria is inactivated
    And The 'library/criteria_templates/Run-in/parent' page is opened
  ...
  Scenario: [Table][Search][Postive case] User must be able to search created Run-in Criteria template
    When [API] Search Test - Create first 'Run-in' criteria template
