...
Feature: Library - Syntax Templates - Criteria - Inclusion - Parent
  ...
  Scenario: [Actions][Availability][Draft item] User must only have access to aprove, edit, delete, history actions for Drafted version of the Inclusion Criteria template
    Given [API] 'Inclusion' Criteria in status Draft exists
    And The 'library/criteria_templates/Inclusion/parent' page is opened
    And User intercept getCriteria request
    And User awaits for the getCriteria request to finish
  ...
  Scenario: [Actions][Availability][Final item] User must only have access to new version, inactivate, history actions for Final version of the Inclusion Criteria template
    Given [API] 'Inclusion' Criteria in status Draft exists
    And [API] Criteria is approved
    And The 'library/criteria_templates/Inclusion/parent' page is opened
    And User intercept getCriteria request
  ...
  Scenario: [Actions][Availability][Final item] User must have access to edit indexing, create pre-instantiation actions for Final version of the Inclusion Criteria template
    Given [API] 'Inclusion' Criteria in status Draft exists
    And [API] Criteria is approved
    And The 'library/criteria_templates/Inclusion/parent' page is opened
    And User intercept getCriteria request
  ...
  Scenario: [Actions][Availability][Retired item]User must only have access to reactivate, history actions for Retired version of the Inclusion Criteria template
    Given [API] 'Inclusion' Criteria in status Draft exists
    And [API] Criteria is approved
    And [API] Criteria is inactivated
    And The 'library/criteria_templates/Inclusion/parent' page is opened
  ...
  Scenario: [Table][Search][Postive case] User must be able to search created Inclusion Criteria template
    When [API] Search Test - Create first 'Inclusion' criteria template
