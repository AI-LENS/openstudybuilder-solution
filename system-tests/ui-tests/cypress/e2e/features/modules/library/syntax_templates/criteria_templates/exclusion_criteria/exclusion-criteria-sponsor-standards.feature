...
Feature: Library - Syntax Templates - Criteria - Exclusion - Parent
  ...
  Scenario: [Actions][Availability][Draft item] User must only have access to aprove, edit, delete, history actions for Drafted version of the Exclusion Criteria template
    Given [API] 'Exclusion' Criteria in status Draft exists
    And The 'library/criteria_templates/Exclusion/parent' page is opened
    And User intercept getCriteria request
    And User awaits for the getCriteria request to finish
  ...
  Scenario: [Actions][Availability][Final item] User must only have access to new version, inactivate, history actions for Final version of the Exclusion Criteria template
    Given [API] 'Exclusion' Criteria in status Draft exists
    And [API] Criteria is approved
    And The 'library/criteria_templates/Exclusion/parent' page is opened
    And User intercept getCriteria request
  ...
  Scenario: [Actions][Availability][Final item] User must have access to edit indexing, create pre-instantiation actions for Final version of the Exclusion Criteria template
    Given [API] 'Exclusion' Criteria in status Draft exists
    And [API] Criteria is approved
    And The 'library/criteria_templates/Exclusion/parent' page is opened
    And User intercept getCriteria request
  ...
  Scenario: [Actions][Availability][Retired item]User must only have access to reactivate, history actions for Retired version of the Exclusion Criteria template
    Given [API] 'Exclusion' Criteria in status Draft exists
    And [API] Criteria is approved
    And [API] Criteria is inactivated
    And The 'library/criteria_templates/Exclusion/parent' page is opened
